...
var levels = {
    respiration: eventData.respirationLevels,
    heartRate: eventData.heartRateLevels,
    oxygenUse: eventData.oxygenUseLevels,
    radiation: eventData.radiationLevels,
    reception: eventData.receptionLevels
};
